...
import com.projectgloriam.parkingservice.data.LoginRepository;
...
public class LoginViewModel extends ViewModel {
    ...
    public void login(String username, String password) {
        ...
        if (result instanceof Result.Success) {
            ...
            loginResult.setValue(new LoginResult(new LoggedInUserView(data.getUserId(),data.getDisplayName(),data.getEmail())));
        } else {
